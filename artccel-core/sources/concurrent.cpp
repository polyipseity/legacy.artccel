...
ARTCCEL_CORE_EXPORT_DEFINITION constexpr
    typename Nullable_lockable<std::mutex>::null_lockable_type
        Nullable_lockable<std::mutex>::null_lockable;
